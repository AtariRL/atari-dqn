...
subprocess.run("python breakout-ufreq-50.py & python breakout-ufreq-100.py & python breakout-ufreq-200.py & python breakout-ufreq-500.py & python special-breakout.py & python breakout-pfreq-200.py & python breakout-pfreq-500.py", shell=True)
