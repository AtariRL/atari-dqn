...
# BREAKOUT
subprocess.run("python breakout-irb-1000.py & python breakout-irb-10000.py & python breakout-irb-50000.py & python breakout-irb-100000.py & python breakout-pfreq-50.py & python breakout-pfreq-100.py", shell=True)
#subprocess.run("python breakout-pfreq-50.py & python breakout-pfreq-100.py", shell=True)
#subprocess.run("python breakout-ufreq-50.py & python breakout-ufreq-100.py & python breakout-ufreq-200.py & python breakout-ufreq-500.py & python special-breakout.py", shell=True)
